...
import PageHeader from "@/components/common/page-title-section";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
                  Golden Ace Ventures LLP is committed to pioneering sustainable
                  solutions across energy, infrastructure, and technology
                  sectors. We envision a future where innovation drives
                  sustainable growth and creates lasting value for our partners
                  and communities.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  expertise, we aim to transform industries and contribute to a
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-card p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-[#FFBF00]/20">
                ...
                <p className="text-muted-foreground">
                  ...
                  ensure long-term benefits for our planet.
                </p>
              </div>
